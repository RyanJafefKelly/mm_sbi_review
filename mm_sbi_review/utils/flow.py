...
# from nflows_pkg import distributions as distributions_
# from nflows_pkg import flows, transforms
# from nflows_pkg.nn import nets
...
#     z_score_parser,
# )
# from utils.torchutils import create_alternating_binary_mask
# from utils.user_input_checks import check_data_device, check_embedding_net_device
...
#     y_numel = embedding_net(batch_y[:1])[1].numel()
...
#         """
#         super().__init__()
#         # `self.hidden_features` is only defined such that nflows_pkg can infer
