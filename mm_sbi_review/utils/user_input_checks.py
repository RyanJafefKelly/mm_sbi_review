...
from .sbiutils import warn_on_iid_x, within_support
...
def process_x(
    x: Any, x_shape: Optional[torch.Size] = None, allow_iid_x: bool = False
) -> Tensor:
...
def test_posterior_net_for_multi_d_x(net: Any, theta: Tensor, x: Tensor) -> None:
